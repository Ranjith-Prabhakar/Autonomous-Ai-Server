...
import { IGitHubRepository, TRepo } from "../../types/repositoryModel";

const GitHubRepoSchema: Schema<TRepo> = new mongoose.Schema(
  {
...
const repoModel: Model<TRepo> = mongoose.model(
  "GitHubUserRepo",
  GitHubRepoSchema
);
